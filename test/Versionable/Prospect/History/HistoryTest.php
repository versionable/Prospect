...
class HistoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
      $entry = $this->getMock('Versionable\Prospect\History\EntryInterface');
      $this->object->add($entry);
      
      $entry2 = $this->getMock('Versionable\Prospect\History\EntryInterface');
      $this->object->add($entry2);
      
      $entry3 = $this->getMock('Versionable\Prospect\History\EntryInterface');
      $this->object->add($entry3);
      
      $this->object->go(-1);
      
      $entry4 = $this->getMock('Versionable\Prospect\History\EntryInterface');
